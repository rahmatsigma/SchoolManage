            ...
            <div class="bg-white/10 backdrop-blur-md border border-white/20 overflow-hidden shadow-xl sm:rounded-2xl p-8">
                ...
                <form action="{{ route('mata-pelajaran.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama_mapel" name="nama_mapel" type="text" class="mt-1 block w-full bg-white/10 text-white border-white/20 focus:ring-blue-500" :value="old('nama_mapel')" required autofocus placeholder="Contoh: Matematika, Bahasa Indonesia" />
                    </div>
